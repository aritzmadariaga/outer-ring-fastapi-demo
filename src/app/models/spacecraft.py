...
class Spacecraft(Base):
    ...
    registry_code = Column(String(255), unique=True, index=True, nullable=False)  #: :no-index:
    ...
    updated_at = Column(DateTime, server_default=func.now(), onupdate=func.now())  #: :no-index:
